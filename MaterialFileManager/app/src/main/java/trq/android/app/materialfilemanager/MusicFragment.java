...
public class MusicFragment extends Fragment {
    ...
    public static MusicFragment newIstance() {
    ...
    private void setupAdapter() {
        ...
        adapter.setOnFileClickedListener(new FileAdapter.onFileClickedListener() {
            ...
            public void onFileClick(String newPath) {
                scrollPosition = ((LinearLayoutManager)recyclerViewMusic.getLayoutManager()).findFirstCompletelyVisibleItemPosition();
                File fileToOpen;
                if (currentDir != null) {
        ...
        (recyclerViewMusic.getLayoutManager()).scrollToPosition(scrollPosition);
